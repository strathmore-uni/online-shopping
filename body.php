					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=79"><div class="shop">
							...
							<div class="shop-body">
								...
								<a href="product.php?p=79" class="cta-btn">nunua sahi!! <i class="fa fa-arrow-circle-right"></i></a>
							</div>
                            </div></a>
					</div>
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									...
									<li><a data-toggle="tab" href="#tab1">masimu</a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<h2 class="text-uppercase">deals moto hii week</h2>
							<p>New Collection mpaka to 50% OFF</p>
							<a class="primary-btn cta-btn" href="store.php">nunua sahi!!!</a>
						</div>
					</div>
				</div>
